...
interface BaseNumberProps {
  ...
  roomType?: 'TreePlaceComfortNumber' | 'FourPlaceComfortNumber' | 'default';
}

const BaseNumber: React.FC<BaseNumberProps> = ({ 
  CarouselComponent, 
  description,
  roomType = 'default'
}) => {
  ...
  const getSleepingPlaces = () => {
    switch(roomType) {
      case 'TreePlaceComfortNumber':
        return 'до 3-х человек';
      case 'FourPlaceComfortNumber':
        return 'до 4-х человек';
    }
  };
